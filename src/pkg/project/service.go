...
import (
	...
	"github.com/fuhsicloud/fuhsicloud/src/amqp"
	...
	"github.com/fuhsicloud/fuhsicloud/src/util/convert"
	"github.com/fuhsicloud/fuhsicloud/src/util/encode"
	"github.com/fuhsicloud/fuhsicloud/src/util/helper"
	"github.com/fuhsicloud/fuhsicloud/src/util/paginator"
...
func (c *service) Monitor(ctx context.Context, metrics, podName, container string) (res map[string]map[string]map[string][]pods.XYRes, err error) {
	...
	// /api/v1/model/namespaces/kube-public/pods/fuhsicloud-6f5987d5df-lhsh5/metrics/ 容器指示
	// /api/v1/model/namespaces/kube-public/pods/fuhsicloud-6f5987d5df-lhsh5/containers/fuhsicloud/metrics 容器指示
