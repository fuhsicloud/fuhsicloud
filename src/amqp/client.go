...
const (
	CronJobTopic   QueueName = "cronjob.fuhsicloud"
	BuildTopic     QueueName = "build.fuhsicloud"
	AlarmTopic     QueueName = "alarm.fuhsicloud"
	NoticeTopic    QueueName = "notice.fuhsicloud"
	ProclaimTopic  QueueName = "proclaim.fuhsicloud"
	MsgWechatTopic QueueName = "msg.wechat.fuhsicloud"
	HookTopic      QueueName = "hook.fuhsicloud"
)
